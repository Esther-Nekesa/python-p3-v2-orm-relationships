...
from department import Department # Import Department for clarity
...
class Employee:
    ...
    def __init__(self, name, job_title, department_id, id=None):
        ...
        self.department_id = department_id # Stores the Foreign Key
    ...
    def instance_from_db(cls, row):
        ...
        if employee:
            ...
            employee.department_id = row[3] # Retrieve department_id
        else:
            # not in dictionary, create new instance and add to dictionary
            employee = cls(row[1], row[2], row[3]) # Pass department_id to __init__
            employee.id = row[0]
